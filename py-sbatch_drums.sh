...
ddsp_run \
  --mode=train \
  --model_dir=/home/amitz/cs236781/project/trained/drums/ \
  --gin_file=models/solo_instrument.gin \
  --gin_file=datasets/tfrecord.gin \
  --gin_param="TFRecordProvider.file_pattern='/home/amitz/cs236781/project/Dataset/Training/drums/drums.tfrecord*'" \
